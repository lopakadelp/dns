...
describe 'Run default provider with AWS' do
  ...
  let(:chef_run_create) do
    ...
    runner.node.override[:dns][:provider] = provider
    runner.node.override[:dns][:credentials] = {
  ...
  let(:chef_run_update) do
    ...
    runner.node.override[:dns][:domain] = domain
    runner.node.override[:dns][:entry][:name] = name
    runner.node.override[:dns][:entry][:value] = updated_value
    runner.node.override[:dns][:entry][:type] = type
    runner.node.override[:dns][:entry][:ttl] = ttl
